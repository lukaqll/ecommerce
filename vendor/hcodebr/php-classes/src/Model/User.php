...
class User extends Model {
	...
	public static function login($login, $password)
	{
		...
		if (count($results) === 0)
		{
			...
			$_SESSION["noexists"] = "Usuario inexistente ou senha inválida";	
		...
		else
		{
			...
			else
			{
				...
				if ($inadmin === true) {
					...
					$link = "http://www.lukacommerce.com.br/admin/forgot/reset?code=$code";

				} else {

					$link = "http://www.lukacommerce.com.br/forgot/reset?code=$code";
					
				}				

				$mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da Qnll Store", "forgot", array(
					"name"=>$data['desperson'],
					"link"=>$link
				));				
